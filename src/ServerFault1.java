...
public class ServerFault1 {
        ...
        for (Post answerPost : posts.values()) {
            if (answerPost.PostTypeId.equals("2")) {
                for (Post post : posts.values()) {
                    if (post.PostTypeId.equals("1") && post.AcceptedAnswerId.equals(answerPost.Id)) {
                       ...
                       // System.out.println(post.AcceptedAnswerId+"  "+u_p.Id);
                    }
                }
            }
        }
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
    	...
    	ServerFault1 s = new ServerFault1();
        s.run();
        long enddTime = System.nanoTime();
        
        System.out.println( "Total Time : "+ (enddTime-startTime));
    }
